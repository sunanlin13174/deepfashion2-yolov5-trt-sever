...
parser.add_argument('--img_path', type=str,default='D:/deepfashion2coco_to_yolo_-master/deepfashion2coco_to_yolo_-master/deepfashion2coco_to_yolo_/Dataset_Deepfashion2/train/Images/',  help='directory of image folder')
parser.add_argument('--label', type=str, default='D:/deepfashion2coco_to_yolo_-master/deepfashion2coco_to_yolo_-master/deepfashion2coco_to_yolo_/Dataset_Deepfashion2/train/train.json', help='directory of label folder or label file path')
parser.add_argument('--convert_output_path', default='D:/coco_clothes', type=str, help='directory of label folder')
...
parser.add_argument('--cls_list_file', type=str, help='directory of *.names file', default="./coco.names")
